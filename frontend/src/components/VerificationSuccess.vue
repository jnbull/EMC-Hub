<template>
    ...
    <div class = 'sectionContainer'>
        ...
        <div class = 'colContainer'>
            ...
            <!-- App Title -->
            <div class = 'title'>
                <!-- <img class = 'bigLogo' src="../assets/biglogo.svg" alt="TUV Logo"> -->
            ...
            <div class = 'successButtonContainer'>
                ...
                <!-- Success Route Options -->
                <form @submit = 'fileOpen' class = 'homeButton' method="POST">
                    <button>
                ...
                <router-link to = '/verifications' class = 'homeButton'>
                    ...
                    <div class = 'startContainer'>
                        <h3 class = 'startSubtitle'><strong>Continue Verifications</strong></h3>
                    </div>
                </router-link>
